...
<div class="container py-5">
    ...
    <div class="mb-4 text-end">
        <a href="?hal=user_tambah" class="btn btn-primary px-4 py-2">Tambah User</a>
        ...
        <table class="table table-dark table-hover" id="myTable">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>" . htmlspecialchars(ucfirst($row['level'])) . "</td>"; 
                    echo "<td>
                            <a href='?hal=user_edit&id=" . $row['userid'] . "' class='btn btn-sm btn-warning'>Edit</a>
                            <a href='?hal=user_hapus&id=" . $row['userid'] . "' class='btn btn-sm btn-danger'>Hapus</a>
                          </td>";
                    echo "</tr>";
                }
